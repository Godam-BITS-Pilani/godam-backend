...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'godam.settings')
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
PROJECT_ROOT = os.path.dirname(os.path.abspath(__file__))

ROOT_URLCONF = 'godam.urls'
WSGI_APPLICATION = 'godam.wsgi.application'

SECRET_KEY = os.environ.get('SECRET_KEY')

ADMINS = [
	('godam Administration', 'godam.developers@gmail.com')
]
...
DEFAULT_FILE_STORAGE = 'godam.media_storages.PublicMediaStorage'
PRIVATE_FILE_STORAGE = 'godam.media_storages.PrivateMediaStorage'
...
EMAIL_HOST_USER = 'godam.developers@gmail.com'
EMAIL_HOST_PASSWORD = os.environ.get('MAILER_PASSWORD')
EMAIL_PORT = 587
DEFAULT_FROM_EMAIL = 'godam.developers@gmail.com'
